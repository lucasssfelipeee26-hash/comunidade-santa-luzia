...
import { ArrowLeft, CheckCircle2, CloudDownload, RefreshCw, Wifi } from "lucide-react"
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#fff2cf_0%,#fffaf0_35%,#fff_72%)] px-4 py-8 text-[#342a2c] sm:py-14">
      <div className="mx-auto max-w-4xl">
        ...
        <section data-native-installed-only className="py-14 text-center">
          <CheckCircle2 className="mx-auto size-16 text-[#0b6b4b]" />
          <h1 className="mt-5 font-serif text-4xl font-semibold text-[#173d2d]">Aplicativo instalado</h1>
          <p className="mx-auto mt-3 max-w-xl text-sm leading-7 text-[#675d5e]">Você já está no aplicativo Santa Luzia. Quando uma nova versão estiver disponível, o aviso de atualização aparecerá automaticamente.</p>
          <Link href="/" className="mt-6 inline-flex rounded-2xl bg-[#7b1326] px-6 py-3 text-sm font-bold text-white">Voltar ao aplicativo</Link>
        </section>

        <div data-web-download-only>
