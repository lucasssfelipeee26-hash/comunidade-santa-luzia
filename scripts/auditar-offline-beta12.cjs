...
const checks = [
  ...
  { area: "Ranking", capability: "Ranking tem cache local validado", file: "android-web/motion/android-domain-bridge-beta10.js", markers: ["/api/ranking", "localRankingEnvelope", "saveLocalRanking", "validRanking"] },
  { area: "Ranking", capability: "Tela de ranking também possui cache local próprio", file: "components/ranking-interativo.tsx", markers: ["carregarCacheRanking", "salvarCacheRanking", "dadosOffline"] },
  ...
  { area: "Jogos", capability: "Joias/Caminho da Luz mantém resultado local", file: "components/caminho-da-luz-entry.tsx", markers: ["CHAVE_PENDENTE", "localStorage.setItem(CHAVE_PENDENTE", "sincronizarPendente", "Resultado guardado no aplicativo"] },
  { area: "Jogos", capability: "Whatajong mantém resultado local", file: "components/whatajong-entry.tsx", markers: ["CHAVE_PENDENTE", "localStorage.setItem(CHAVE_PENDENTE", "sincronizarPendente", "Resultado salvo no aparelho"] },
  { area: "Jogos", capability: "Ponte nativa não confirma resultado de jogo enquanto offline", file: "android-web/motion/android-domain-bridge-beta10.js", markers: ["caminho-da-luz", "whatajong", "Resultado do jogo guardado no aparelho"] },
  { area: "Perfil", capability: "Perfil pessoal possui atualização otimista e cache local", file: "android-web/motion/android-local-first-beta8.js", markers: ["/api/perfil", "santa-luzia:offline:v1:meu-perfil", "offline_pendente"] },
  { area: "Perfil", capability: "Equipe e membros usam estado local", file: "android-web/motion/android-member-state-beta8.js", markers: ["/api/membros", "/api/equipe", "motionMemberStateFetch"] },
  ...
  { area: "Banco local", capability: "SQLite possui integridade, WAL e backup da versão anterior", file: "native-assets/android/src/main/java/br/com/comunidadesantaluzia/app/OfflineStorePlugin.java", markers: ["setWriteAheadLoggingEnabled(true)", "PRAGMA integrity_check", "backupPreviousValue", "TABLE_BACKUPS", "beginTransaction"] },
