...
const checks = [
  ...
  { area: "Banco local", capability: "SQLite possui integridade, WAL e backup da versão anterior", file: "native-assets/android/src/main/java/br/com/comunidadesantaluzia/app/OfflineStorePlugin.java", markers: ["journal_mode=WAL", "integrity_check", "previous:", "beginTransaction"] },
