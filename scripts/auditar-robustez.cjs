...
console.log("[1/7] Versões e distribuição")
...
console.log("\n[2/7] Atualização instantânea e reconexão")
...
console.log("\n[4/7] Sessão, cadastro e recuperação")
...
console.log("\n[7/7] Inventário quadro por quadro")
...
if (rateLimit.includes("new Map")) aviso("Rate limit é local ao processo", "migrar para armazenamento compartilhado antes de múltiplas réplicas")
