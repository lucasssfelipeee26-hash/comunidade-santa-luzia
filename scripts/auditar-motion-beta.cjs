...
requireAll("components/ranking-trophy.tsx", ["RankingTrophy", "data-ranking-trophy-react", "viewBox=\"0 0 64 64\"", "memo", "useMemo"], "Pódio React atual")
forbid("components/ranking-trophy.tsx", ["dangerouslySetInnerHTML", "MutationObserver", "innerHTML"], "Pódio React não pode voltar à injeção DOM")
