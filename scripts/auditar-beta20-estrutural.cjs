...
ok(authClientFinal.includes("authGeneration") && authClientFinal.includes("authMeInFlight") && !authClientFinal.includes("AUTH_ME_RECENT_MS"), "auth/me compartilha somente a requisição em voo, sem cache resolvido")
