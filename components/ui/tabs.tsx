...
function TabsList({className,...props}:React.HTMLAttributes<HTMLDivElement>&{variant?:"default"|"line"}){return <div role="tablist" data-slot="tabs-list" className={cn("w-fit items-center rounded-lg bg-muted p-[3px]",className)} {...props}/>} 
