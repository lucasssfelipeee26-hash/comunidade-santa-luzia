        ...
        {items.map((item) => {
          ...
          return (
            <Link
              ...
              className={`flex min-w-0 flex-col items-center justify-center gap-0.5 px-0.5 py-1.5 font-bold transition-colors duration-100 active:opacity-80 ${active ? "text-[#7b1326]" : "text-[#786b68]"}`}
            >
              <span
