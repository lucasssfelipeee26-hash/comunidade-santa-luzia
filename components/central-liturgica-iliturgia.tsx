...
import { comentariosILiturgia, oracoesILiturgia } from "@/lib/iliturgia-menus"
...
type Submenu="ordinario"|"eucaristicas"|"prefacios"|"prefacios-proprios"|"prefacios-tempo"|"catequeses"|"comentarios"|"oracoes"|null
...
const oracoesTelas:Tela[]=oracoesILiturgia.map(x=>({...x,categoria:"geral"}))
...
export function CentralLiturgicaILiturgia(){
 ...
 const horas=useMemo<Tela[]>(()=>horasBase.map(h=>({id:h.id,titulo:h.titulo,categoria:"oficio",documento:documentoHoraSanto(chave,h.id)||documentoHoraTemporal(agora,h.id)})),[agora,chave])
 ...
 const missal:Tela[]=[{id:"ordinario",titulo:"Ordinário da Missa"},{id:"prefacios",titulo:"Prefácios"},{id:"eucaristicas",titulo:"Orações Eucarísticas"},{id:"proprio",titulo:"Próprio do Missal do dia",categoria:"missal",documento:proprioMissal}]
 const mais:Tela[]=[
  ...
  {id:"catequeses",titulo:"Catequeses"},{id:"comentarios",titulo:"Comentários litúrgicos"},{id:"oracoes",titulo:"Orações"},{id:"indice",titulo:"Índice Geral",categoria:"oficio",documento:"oficio/indice.htm"},
 ]
 function abrir(t:Tela){
  if(t.id==="ordinario"||t.id==="eucaristicas"||t.id==="prefacios"||t.id==="prefacios-proprios"||t.id==="prefacios-tempo"||t.id==="catequeses"||t.id==="comentarios"||t.id==="oracoes"){setSubmenu(t.id as Submenu);return}
  setTela(t)
 }
