...
export function CentralLiturgicaILiturgia(){
 ...
 const mais:Tela[]=[
  ...(documentoEvangelho?[{id:"evangelho",titulo:"Evangelho e Lectio Divina",categoria:"evangelho",documento:documentoEvangelho}]:[]),
  ...(lecionario?[{id:"lecionario",titulo:"Lecionário do dia",categoria:"lecionario",documento:lecionario}]:[]),
  ...
  {id:"catequeses",titulo:"Catequeses"},{id:"comentarios",titulo:"Comentários litúrgicos"},{id:"oracoes",titulo:"Orações"},{...indiceGeralILiturgia,categoria:"geral"},
 ]
 ...
 return <section className="relative min-h-[82vh] overflow-hidden rounded-2xl border border-[#745a3d]/30 bg-[#efe2bf] pb-20 shadow-sm">
  ...
  <div className="mx-auto max-w-4xl p-3 sm:p-5">
   ...
   {modulo==="oficio"&&<div className="space-y-3">{submenu==="vigilia"&&<button onClick={()=>setSubmenu(null)} className="inline-flex items-center gap-2 rounded-full border border-[#80694d]/35 bg-[#fff7df] px-3 py-2 text-sm font-semibold text-[#5b3d29]"><ChevronLeft className="size-4"/>Ofício</button>}{submenu==="vigilia"?<ListaModulo itens={vigilia} abrir={abrir}/>:<ListaModulo itens={horas} abrir={abrir}/>}</div>}
