...
export function CentralLiturgicaILiturgia(){
 ...
 const complementosLiturgia:Tela[]=[
 ...
 return <section className="relative min-h-[82vh] overflow-hidden rounded-2xl border border-[#745a3d]/30 bg-[#efe2bf] pb-24 shadow-sm">
  ...
  <div className="mx-auto max-w-4xl p-3 sm:p-5">
   ...
   {modulo==="liturgia"&&<div className="space-y-5"><LiturgiaDiaria/>{complementosLiturgia.length>0&&<section><p className="mb-2 px-1 text-[11px] font-bold uppercase tracking-[.18em] text-[#997026]">Conteúdo litúrgico do dia</p><ListaModulo itens={complementosLiturgia} abrir={abrir}/></section>}</div>}
