...
import { AlertCircle, BookOpen, CalendarDays, CheckCircle2, ChevronLeft, ChevronRight, Database, Loader2 } from "lucide-react"
  ...
  return <div className="overflow-hidden rounded-3xl border border-border/80 bg-white/90 shadow-sm">
    ...
    <div className="p-3 sm:p-5">
      ...
      <div className="mt-3 rounded-2xl border bg-white/70 p-4">
        ...
        <p className="mt-2 text-xs text-muted-foreground">Origem interna: {data.fonte?.nome}. {data.fonte?.licenca}</p>
      </div>
