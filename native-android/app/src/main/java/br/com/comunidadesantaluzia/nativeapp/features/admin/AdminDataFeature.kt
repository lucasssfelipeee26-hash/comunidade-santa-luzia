...
internal suspend fun loadAdminData(container: AppContainer): AdminDataState = when (
    val result = container.repository.readLocalFirst("admin-dados", "/api/app/admin-dados", authenticated = true)
) {
